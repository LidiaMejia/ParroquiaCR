        ...
        <form action="index.php?page=producto&mode={{mode}}&codprd={{codprd}}" method="POST"  class="col-12 col-md-8 col-offset-2 formMan">
            ...
            <fieldset>
                ...
                <select name="catprd" {{if isReadOnly}} disabled readonly {{endif isReadOnly}}>
                    <option value="LBA" {{catLBATrue}}>Libra de Amor</option>
                    <option value="COM" {{catCOMTrue}}>Comedor</option>
                    <option value="CLN" {{catCLNTrue}}>Clínica</option>
                    <option value="OBS" {{catOBSTrue}}>Obras Sociales</option>
                    <option value="REM" {{catREMTrue}}>Obras de Remodelación</option>
