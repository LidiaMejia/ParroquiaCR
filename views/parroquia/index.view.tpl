...
<section class="about-us">
    <div class="contenedor1">
        <h2 class="titulo">Horarios de Misa</h2>
        <div class="contenedor-articulo">
            ...
            <div class="articulo" data-aos="zoom-in-right">
                <i class="fas fa-church"></i>
                <h3>Yaguacire</h3>
                <p><b>Jueves: </b> 6:00 PM
                <br>
                <br>
                <b>Domingos: </b> 7:00 AM</<b>
            ...
            <div class="articulo" data-aos="zoom-in-right">
                ...
                <p><b>Miercoles:</b> 6:00 PM
                <br>
                <br>
                <b>Domingos: </b> 4:30 PM</<b>
                
            </div>
            <div class="articulo" data-aos="zoom-in-right">
                <i class="fas fa-church"></i>
                <h3>Camino Neo-Catecumenal</h3>
                <p><b>Sabados: </b>6:00 PM
                    <br>
                    <br>
                    </p>
            </div>
...
<section class="clientes contenedor">
    <h2 class="titulo">Nuestros Sacerdotes</h2>
    <div class="cards">
        <div class="card">
